...
// WiFi network info.
const char *ssid =  "JCBRO";     // Enter your WiFi Name
const char *pass =  "jcbro@321"; // Enter your WiFi Password
    ...
    {            
      ...
      {                
        char c = client.read();                // read a byte
          ...
          {     
            client.print("<html><title> MPU9250 Data On WEB SERVER </title></html>");
            client.print("<body bgcolor=\"#E6E6FA\"><h1 style=\"text-align: center; color: blue\">MPU9250 Data On WEB SERVER</h1>");
