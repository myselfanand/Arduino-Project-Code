...
#define RIGHT 13              // Right IR sensor connected to analog pin A2 of Arduino Uno:
#define LEFT 14               // Left IR sensor connected to analog pin A3 of Arduino Uno:
#define TRIGGER_PIN 22        // Trigger pin connected to analog pin A1 of Arduino Uno:
#define ECHO_PIN 23           // Echo pin connected to analog pin A0 of Arduino Uno:
