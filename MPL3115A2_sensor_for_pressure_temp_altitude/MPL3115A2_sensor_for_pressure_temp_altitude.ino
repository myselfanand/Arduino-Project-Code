...
client.println("</style></head><body style=background-color:LemonChiffon><h1>ESP32 Web Server MPL3115A2 Sensor</h1>");
client.println("<h2>MPL3115A2 Barometic sensor</h2>");
